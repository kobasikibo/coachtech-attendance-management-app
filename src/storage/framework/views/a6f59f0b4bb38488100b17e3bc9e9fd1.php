...
<div class="date-navigation">
    <div class="navigation-item">
        ...
        <a class="navigation-link" href="<?php echo e(route('admin.attendance.index', ['date' => \Carbon\Carbon::parse($currentDay)->subDay()->format('Y-m-d')])); ?>">前日</a>
    </div>
    ...
    <div class="navigation-item">
        <?php if($currentDay < now()->format('Y-m-d')): ?>
            <a class="navigation-link" href="<?php echo e(route('admin.attendance.index', ['date' => \Carbon\Carbon::parse($currentDay)->addDay()->format('Y-m-d')])); ?>">翌日</a>
