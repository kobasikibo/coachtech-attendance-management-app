...
<?php if($correctionRequest->status === \App\Models\AttendanceCorrectRequest::STATUS_PENDING): ?>
<div class="alert">
    *承認待ちのため修正はできません。
</div>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/stamp_correction_request/show.blade.php ENDPATH**/ ?>