...
<link rel="stylesheet" href="<?php echo e(asset('css/admin-attendance-staff.css')); ?>" />
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<h1><?php echo e($user->name ?? ''); ?>さんの勤怠</h1>

<div class="month-navigation">
    <div class="navigation-item">
        <img src="<?php echo e(asset('images/icons/selector-left.png')); ?>" alt="前月へ移動" class="selector-icon">
        <a class="navigation-link" href="<?php echo e(route('admin.attendance.staff', ['id' => $user->id, 'month' => $previousMonth])); ?>">前月</a>
    </div>
    ...
    <div class="navigation-item <?php echo e($currentMonth->format('Y-m') ==  now()->format('Y-m') ? 'invisible' : ''); ?>">
        <a class="navigation-link" href="<?php echo e(route('admin.attendance.staff', ['id' => $user->id, 'month' => $nextMonth])); ?>">翌月</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-cell">
                ...
                <a class="table-link" href="<?php echo e(route('admin.attendance.show', $attendanceForDate->id)); ?>">詳細</a>
                <?php endif; ?>
            </td>
        </tr>
...
<div class="csv-export">
    <a class="btn-export"
        href="<?php echo e(route('admin.attendance.export', ['id' => $user->id, 'month' => $currentMonth->format('Y-m')])); ?>">
        CSV出力
    </a>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/attendance/staff.blade.php ENDPATH**/ ?>