...
<form method="POST" action="<?php echo e(route('attendance.request', $attendance->id)); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
        ...
        <div class="form-date">
            ...
            <div class="form-input-container">
                <p class="attendance-year"><?php echo e($attendanceService->getYearFromDate($attendance)); ?></p>
                <p class="attendance-date"><?php echo e($attendanceService->getMonthDayFromDate($attendance)); ?></p>
            </div>
        </div>
