...
<table class="attendance-table">
    ...
    <tbody>
        <?php $__currentLoopData = $correctionRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $correction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td class="table-cell"><?php echo e($correction->status); ?></td>
            <td class="table-cell"><?php echo e($correction->attendance->user->name); ?></td>
            <td class="table-cell"><?php echo e(\Carbon\Carbon::parse($correction->attendance->date)->translatedFormat('Y/m/d')); ?></td>
