    ...
    <header class="header">
        <div class="header-inner">
            <div class="header-container">
                <a class="header-logo" href="<?php echo e(Route::currentRouteName() === 'login' ? route('admin.login.create') : (Route::currentRouteName() === 'admin.login.create' ? route('login') : route('attendance.create'))); ?>">
            ...
            <div class="header-container">
                <div class="header-links">
                    ...
                    <a href="<?php echo e(route('admin.staff.index')); ?>" class="link-staff-list">スタッフ一覧</a>
            ...
            <div class="header-container">
                <div class="header-links">
                    ...
                    <a href="<?php echo e(route('stamp_correction_request.index')); ?>" class="link-request">申請</a>
