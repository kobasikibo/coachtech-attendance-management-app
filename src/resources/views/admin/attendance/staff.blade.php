...
<div class="month-navigation">
    <div class="navigation-item">
        ...
        <a class="navigation-link" href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $previousMonth]) }}">前月</a>
    </div>
    ...
    <div class="navigation-item {{ $currentMonth->format('Y-m') ==  now()->format('Y-m') ? 'invisible' : '' }}">
        <a class="navigation-link" href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $nextMonth]) }}">翌月</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-cell">
                ...
                <a class="table-link" href="{{ route('admin.attendance.show', $attendanceForDate->id) }}">詳細</a>
                @endif
            </td>
        </tr>
        @endforeach
...
<div class="csv-export">
    <a class="btn-export"
        href="{{ route('admin.attendance.export', ['id' => $user->id, 'month' => $currentMonth->format('Y-m')]) }}">
        CSV出力
    </a>
</div>
@endsection