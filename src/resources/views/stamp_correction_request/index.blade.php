...
<div class="tab-container">
    <a href="{{ url('/stamp_correction_request/list?tab=pending') }}" class="tab-link {{ $tab === 'pending' ? 'active' : '' }}">承認待ち</a>
    <a href="{{ url('/stamp_correction_request/list?tab=approved') }}" class="tab-link {{ $tab === 'approved' ? 'active' : '' }}">承認済み</a>
</div>
...
<table class="attendance-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="table-cell">
                <a class="table-link" href="{{ route('stamp_correction_request.show', $correction->id) }}">詳細</a>
            </td>
        </tr>
        @endforeach
    </tbody>
...
@section('scripts')
<script src="{{ asset('js/tab-selector.js') }}" defer></script>
@endsection